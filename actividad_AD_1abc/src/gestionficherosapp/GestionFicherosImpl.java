...
////////////////////////////
	...
	public void creaCarpeta(String arg0) throws GestionFicherosException {
		...
		if(file.exists()){
			throw new GestionFicherosException("error, el directorio ya existe");
		}
			...
			if(carpetaDeTrabajo.canWrite()){
				if(file.isDirectory()){
					...
					if(numArchivos==0){
						...
						throw new GestionFicherosException("error el directorio no esta vacio");
					}
				}else{
					if(file.isFile()){
						file.delete();
				...
				throw new GestionFicherosException("error el directorio no tiene permisos de escritura");
			}
		}else{
			throw new GestionFicherosException("error el directorio no existe");
		}
		actualiza();
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public String getInformacion(String arg0) throws GestionFicherosException {
		...
		if(!file.exists()){
			throw new GestionFicherosException("El archio no existe, revisa el nombre");
		}
		...
		//Fecha de última modificación
			...
			strBuilder.append("Ultima modificai�n : ");
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void renombra(String arg0, String arg1)throws GestionFicherosException {
		...
		if(!file.exists()){
			throw new GestionFicherosException("error , el archivo/directorio no se encuentra");
		}
		if(file2.exists()){
			throw new GestionFicherosException("error al renombrar");
		}
		try{
			file.renameTo(file2);
		}catch(Exception e){
			throw new GestionFicherosException("rename error");
		}
		actualiza();
